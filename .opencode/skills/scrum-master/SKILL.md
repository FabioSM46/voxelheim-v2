---
name: scrum-master
description: Use ONLY when the user explicitly requests /scrum-master. Scrum ceremony facilitator. Use for backlog refinement, iteration planning, and feature specification.
