...
func TestOnlyTheAgreedEquipmentWearsOut(t *testing.T) {
	...
	want := map[ItemID]uint16{
		...
		ItemRustyHelm:       RustyArmourMaxDurability,
		ItemRustyCuirass:    RustyArmourMaxDurability,
		ItemRustyGreaves:    RustyArmourMaxDurability,
		ItemWoodenShield:    WoodenShieldMaxDurability,
		ItemBow:             BowMaxDurability,
		ItemWoodenSceptre:   SceptreMaxDurability,
	}
