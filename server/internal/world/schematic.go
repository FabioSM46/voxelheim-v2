...
// keepSchematic is 15×14×15: a wall ring five courses high with a gate in it, and a
// tower inside the courtyard that is the tallest thing a capital has.
//
// **The wall ring is part of the building rather than a feature of the settlement**,
// which is what keeps the whole of a capital's centre one pure function of one lattice
// cell: there is no second pass that draws a perimeter, and a chunk that holds only a
// corner of the wall reaches it by visiting this drawing like any other.
var keepSchematic = mustSchematic(
	...
	[]string{ // y=0 — wall, tower, open gate and open tower door
		"###############",
		"#_____________#",
		"#_____________#",
		"#_____________#",
	...
	[]string{ // y=3 — the lintels close both openings
		"###############",
		"#_____________#",
		"#_____________#",
		"#_____________#",
	...
	[]string{ // y=4 — the top course of the wall ring
		"###############",
		"#_____________#",
		"#_____________#",
		"#_____________#",
	...
	[]string{ // y=5 — the tower alone from here up
		"_______________",
		"_______________",
		"_______________",
		"_______________",
	...
	[]string{ // y=8 — one window on each of the tower's four faces
		"_______________",
		"_______________",
		"_______________",
		"_______________",
	...
	[]string{ // y=12 — the tower's roof, overhanging by one
		"_______________",
		"_______________",
		"_______________",
		"___PPPPPPPPP___",
