...
// keepSchematic is 21×20×21: the capital's castle — a curtain wall two courses thick
...
// the wall reaches it by visiting this drawing like any other. At 21×20×21 it straddles
...
// the way up; a third, in the courtyard, reaches the wall walk.
//
// **What this does not have yet**: the four corner towers, the walkway spanning two of
// them and the corbelled capitals. They are #555's second half, built upward from the
// parapet this one ends at.
