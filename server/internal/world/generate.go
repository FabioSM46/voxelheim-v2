...
// 35 → 36: internal east spire stairs, guarded lookouts and audience dais.
// 36 → 37: full-depth barred hall and tower windows, including exterior slate trim.
const WorldgenVersion uint32 = 37
