...
//
// A named string type rather than a string, for the reason identity.Token is a named
...
//     exactly the trap identity.Token documents, arriving here as a string rather than
//     as a byte array.
