...
argument-hint: <iteration-number-or-milestone>
allowed-tools: Agent Monitor Bash(gh *) Bash(git *) Bash(bash *) Bash(cd *) Bash(mkdir *) Bash(mktemp *) Bash(rm *) Bash(cat *) Bash(sed *) Bash(awk *) Bash(rg *) Bash(sleep *) Bash(date *) Bash(dirname *) Bash(echo *) Bash(set *) Bash(jq *)
---
...
Use the **Agent tool** to start exactly one owning agent for each issue in the ready wave, up to
