...
allowed-tools: Agent Bash(gh *) Bash(git *) Bash(bash *) Bash(cd *) Bash(mkdir *) Bash(mktemp *) Bash(rm *) Bash(cat *) Bash(sed *) Bash(awk *) Bash(rg *) Bash(sleep *) Bash(date *) Bash(dirname *) Bash(echo *) Bash(set *) Bash(jq *)
---
